...
public class DatabaseAgent {
	...
	private static Collection<StopLocation> getClosestStops(ContentResolver resolver, 
		...
		Uri uri;
		String[] projectionIn = new String[] {Schema.Stops.tagColumnOnTable, DatabaseContentProvider.DISTANCE_KEY};
		...
		try
		{
			...
			cursor = resolver.query(uri, projectionIn, select, null, DatabaseContentProvider.DISTANCE_KEY);
			if (cursor.moveToFirst() == false)
			{
