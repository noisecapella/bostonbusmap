...
public class TestDateFormat extends TestCase
{
	public void testBasic1() throws ParseException
	{
		...
		SubwayPredictionsFeedParser parser = new SubwayPredictionsFeedParser("Red", null, null, null, null, new ConcurrentHashMap<String, BusLocation>(), new HashMap<String, String>());
	...
	public void testBasic2() throws ParseException
	{
		...
		SubwayPredictionsFeedParser parser = new SubwayPredictionsFeedParser("Orange", null, null, null, null, new ConcurrentHashMap<String, BusLocation>(), new HashMap<String, String>());
	...
	public void testBasic3() throws ParseException
	{
		...
		SubwayPredictionsFeedParser parser = new SubwayPredictionsFeedParser("Blue", null, null, null, null, new ConcurrentHashMap<String, BusLocation>(), new HashMap<String, String>());
