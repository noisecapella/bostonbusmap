...
public class LABusTransitSource extends NextBusTransitSource
{
	...
	protected void addRoutes()
	{
		...
		addRoute("37", "37 14 Beverly Hlls-Dtwn LA-Wash/Fairfax Via Beverly-Adam");
		addRoute("38", "38 35 Downtown LA- Wla Via Washington Bl & Jefferson Bl");
		addRoute("40", "40 Dtwn LA-Lax-Sbay Gallria Via King-Latijera-Hawthrn");
		addRoute("42", "42 40 Dtwn LA-Lax-Sbay Gallria Via King-Latijera-Hawthrn");
		addRoute("45", "45 Lincoln Heights - Dwntwn LA- Rosewood Via Broadway");
		addRoute("48", "48 10 W Hollywood-Dtwn LA -Avalon Sta Via Melrose-Avalon");
		addRoute("51", "51 Wilshr Ctr-Dtwn LA-Compton-Artesia Tran Via Avalon");
		addRoute("52", "52 51 Wilshr Ctr-Dtwn LA-Compton-Artesia Tran Via Avalon");
		...
		addRoute("68", "68 84 Eagle Rock-Dtwn LA-Montebello Via Eagle Rck-Chavez");
		...
		addRoute("79", "79 78 Downtown LA - Arcadia Via Las Tunas-Huntington Drs");
		...
		addRoute("91", "91 90 Downtown LA- Sunland Via Foothill Bl - Glendale Av");
		...
		addRoute("125", "125 El Segundo - Norwalk Station Via Rosecrans Av");
		...
		addRoute("128", "128 Compton Sta - Cerritos Towne Center Via Alondra Bl");
		addRoute("130", "130 Redondo Beach - Los Cerritos Center Via Artesia Bl");
		...
		addRoute("181", "181 180 Hollywood-Glendale-Pasadena Via Los Feliz-Colorado");
		addRoute("183", "183 Sherman Oaks - Glendale Via Magnolia Bl");
		addRoute("190", "190 El Monte Sta - Cal Poly Pomona Via Ramona - Valley");
		addRoute("194", "194 190 El Monte Sta - Cal Poly Pomona Via Ramona - Valley");
		...
		addRoute("205", "205 Imperial/Wilmgtn Sta-San Pedro Via Wilmgtn-Vermont");
		...
		addRoute("215", "215 211 Inglewood - Redondo Beach Via Prairie - Inglewood");
		...
		addRoute("232", "232 Lax City Bus Ctr-Long Beach-Via Sepulveda Bl - Pch");
		...
		addRoute("237", "237 236 Sylmar Sta-Encino- Sherman Oaks Via Balboa-Woodley");
		addRoute("239", "239 Sylmar Sta - Encino Via White Oak - Zelzah Avs");
		addRoute("240", "240 150 Canoga Pk-Northridge-Universal City Via Ventura Bl");
		addRoute("242", "242 243 Porter Rnch-Woodland Hils Via Tampa - Winnetka Avs");
		addRoute("243", "243 Porter Rnch-Woodland Hils Via Tampa - Winnetka Avs");
		addRoute("244", "244 245 Chatsworth Sta-Woodlnd Hls Via De Soto-Topanga Cyn");
		...
		addRoute("264", "264 267 Pasadena - Altadena - City Of Hope - El Monte Sta");
		...
		addRoute("287", "287 176 Highland Park - Montebello Via Mission-Tyler-Rush");
		addRoute("290", "290 Sylmar - Sunland Via Foothill Bl");
		addRoute("292", "292 Sylmar Sta-Burbank Sta Via Glenoaks Bl");
		addRoute("302", "302 2 Downtown LA - Pacific Palisades Via Sunset Bl");
		addRoute("305", "305 Westwood - Leimert Park - South LA - Willowbrook");
		addRoute("311", "311 111 Lax City Bus Ctr - Norwalk Sta Via Florence Av");
		addRoute("312", "312 212 Hollywood/Vine Sta - Hawthorne Sta Via La Brea Av");
		addRoute("316", "316 16 Downtown LA - Century City Via West 3rd St");
		addRoute("344", "344 Artesia Transit Ctr- Palos Verdes Via Hawthorne Bl");
		addRoute("352", "352 51 Wilshr Ctr-Dtwn LA-Compton-Artesia Tran Via Avalon");
		addRoute("353", "353 152 Woodland Hills - N Hollywood Sta Via Roscoe Bl");
		addRoute("355", "355 55 Downtown LA - Imperial/Wilmngtn Sta Via Compton Av");
		addRoute("358", "358 108 Marina Del Rey - Pico Rivera Via Slauson Av");
		addRoute("363", "363 163 West Hills -Sun Valley-N Hollywood Via Sherman Way");
		addRoute("364", "364 166 Chatsworth Sta -Sun Valley Via Nordhoff-Osborne St");
		addRoute("378", "378 78 Downtown LA - Arcadia Via Las Tunas-Huntington Drs");
		...
		addRoute("489", "489 487 Downtown LA - S Madre Villa Sta - El Monte Sta");
		...
		addRoute("656", "656 156 Panorama -Van Nuys-Hollywood Via Chandler-Cahuenga");
		addRoute("665", "665 Cal State LA - City Terrace Shuttle");
		addRoute("685", "685 Glendale College - Glassell Park Via Verdugo Rd");
		addRoute("686", "686 687 Altadena-Pasadena Via Fair Oaks-Los Robles-Allen");
